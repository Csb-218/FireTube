...
const VideoCard = ({videoData,thumbnail,title,description,channelTitle}) => {

    return (
        
        <div class="group flex flex-col h-full  shadow-sm rounded-xl ">
            <div class="h-52 flex flex-col justify-center items-center bg-white rounded-xl overflow-clip">
                ...
                <img className="object-scale-down" src={thumbnail}/>
            </div>
            <div class="p-2 h-2/5 ">
