...
function OffCanvas() {
  ...
  return (
    <>
      ...
      <div id="hs-overlay-example" class="hs-overlay hs-overlay-open:translate-x-0  -translate-x-full fixed top-0 left-0 transition-all duration-300 transform h-full max-w-xs w-full z-[60] bg-white border-r dark:bg-gray-800 dark:border-gray-700 hidden" tabindex="-1">
        <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">

          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="red" class="bi bi-youtube" viewBox="0 0 16 16">
          ...
          <nav class="flex flex-col space-x-2">
            {
              sidebar_items && sidebar_items.map(item => {
                return (
                  ...
                  class={select === item.id ? "selected_tab cursor-pointer " : "unselected_tab cursor-pointer"} 
