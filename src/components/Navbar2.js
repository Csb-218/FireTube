...
function Navbar2() {
    ...
    return (
        <>
            <header class="flex lg:h-16 h-14 sticky top-0 flex-wrap sm:justify-start sm:flex-nowrap z-50 w-screen bg-white text-sm py-4 dark:bg-black">
                <nav class=" w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between " aria-label="Global">
                    ...
                    <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
                        <div class="flex flex-col gap-3 mt-1 py-2 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5 bg-black">
                            {/* searchbox */}
